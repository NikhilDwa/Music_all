...
def findksimilaritems(item_id, listen_count, metric='cosine', k=6):
    similarities=[]
    indices=[]
...
def get_songs(user_id,item_id):
    ...
    pearison_sim = 1 - pairwise_distances(item_dataframe.as_matrix(), metric="cosine")
    ...
    #print(mse**0.5)
    return(prediction_dataframe['item'][:5])
